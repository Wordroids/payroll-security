    ...
    <div class="h-full px-4 pb-6 overflow-y-auto bg-white">
        <ul class="space-y-2 text-sm font-medium text-gray-700">
                ...
                <button type="button"
                    ...
                    <svg class="w-5 h-5 text-gray-500 group-hover:text-indigo-600" fill="none" stroke="currentColor"
                        ...
                        <path stroke-linecap="round" stroke-width="2"
                            d="M3 21h18M4 18h16M6 10v8m4-8v8m4-8v8m4-8v8M4 9.5v-.95a1 1 0 0 1 .45-.85l7-4.5a1 1 0 0 1 1.1 0l7 4.5a1 1 0 0 1 .45.85v.95a.5.5 0 0 1-.5.5h-15a.5.5 0 0 1-.5-.5Z" />
                    </svg>
            ...
            <li>
                ...
                <ul id="dropdown-attendance" class="hidden ml-7 mt-1 space-y-1">
                    <li><a href="{{ route('attendances.index') }}"
                            class="block px-2 py-1 rounded hover:bg-gray-100 transition">All Attendances</a></li>
                    <li><a href="{{ route('attendances.site-entry') }}"
                            class="block px-2 py-1 rounded hover:bg-gray-100 transition">Mark Attendance</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul id="dropdown-salaries" class="hidden ml-7 mt-1 space-y-1">
                    <li><a href="{{ route('salary.advance') }}"
                            class="block px-2 py-1 rounded hover:bg-gray-100 transition">Salary Advances</a></li>
                    <li><a href="{{ route('salaries') }}"
                            class="block px-2 py-1 rounded hover:bg-gray-100 transition">Salaries</a></li>
                    <li><a href="{{ route('salaries.overview') }}"
        ...
        <div class="absolute bottom-4 left-0 w-full px-4">
            <p class="text-xs text-gray-400 text-center">
                &copy; {{ now()->year }} <a class="text-purple-600 hover:font-bold" target="blank"
                    href="https://wordroids.com">Wordroids</a>. All rights reserved.
            </p>
        </div>
    </div>
</aside>
