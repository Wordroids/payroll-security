        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchInput.addEventListener('input', function() {
                ...
                if (searchTerm === '') {
                    ...
                    // Show total row
                    const totalRow = document.querySelector('tr:has(td:contains("Total Uniform Costs"))');
                    if (totalRow) {
                ...
                tableRows.forEach(row => {
                    // Skip the "no uniform records found" row and total row
                    ...
                    cells.forEach((cell, index) => {
                        if (index < 2) {  // only Emp No and Name columns
                        ...
                        <div class="overflow-visible shadow-sm ring-1 ring-black/5 sm:rounded-lg">
                          <div style="height: calc(100vh - 250px); overflow: auto;">
                                ...
                                <div id="noResultsMessage" class="no-results" style="display: none;">
                                    <p>No uniform records found matching your search criteria.</p>
                                </div>
